            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card my-4 col-4">
                        <form action="{{route('update_type_product', $type_pr->id)}}" method="post" enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="" class="form-control" placeholder="{{$type_pr->name}}" style="margin-left: 10px">
                            </div>
                            <div class="form-group">
                                <label for="" style="margin-left: 10px">Description*</label>
                                <input type="text" name="description" id="" class="form-control" placeholder="{{$type_pr->description}}" style="margin-left: 10px">
                            </div>
                            <div class="form-group">
