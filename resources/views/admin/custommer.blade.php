    ...
    >
        ...
        <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="{{route('slides')}}">
                        <div
                            class="text-white text-center me-2 d-flex align-items-center justify-content-center"
                        >
                            <i class="material-icons opacity-10"
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="{{route('signout')}}">
                        <div
                            class="text-white text-center me-2 d-flex align-items-center justify-content-center"
                        >
                    ...
                    <ul class="navbar-nav justify-content-end">
                        <li class="nav-item d-flex align-items-center">
                            ...
                            >
                                ...
                                @if(Auth::check())
                                    <span class="d-sm-inline d-none">Chào bạn {{Auth::user()->full_name}}</span>
                                @endif
                            </a>
                        </li>
                        <li
                ...
                <div class="col-lg-7 position-relative z-index-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-sm-5 mt-sm-0 mt-4">
                            <div class="card mb-2">
                                <div
                                    class="card-header p-3 pt-2 bg-transparent"
                                >
                                    <div
                    ...
                    <div class="card z-index-2 mt-4">
                        <div class="card-body mt-n5 px-3">
                            ...
                            <p class="text-sm ms-2">
                                (<span class="font-weight-bolder">+11%</span>)
                                than last week
                            </p>
                                ...
                                <div class="row">
                                    <div class="col-3 py-3 ps-0">
                                        <div class="d-flex mb-2">
                                            ...
                                            <p
                                                class="text-xs my-auto font-weight-bold"
                                            >
                                                Users
                                            </p>
                                        </div>
