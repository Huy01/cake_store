        ...
        <nav
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Update User</h6>
                </nav>
                <div
                ...
                <div class="col-12">
                    ...
                    <div class="card my-4 col-4">
                        <form action="{{route('update', $user->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="" style="margin-left: 10px">Full Name*</label>
                                <input type="text" name="full_name" id="" class="form-control" placeholder="{{$user->full_name}}" style="margin-left: 10px">
                            </div>
                            <div class="form-group">
                                <label for="" style="margin-left: 10px">Email*</label>
                                <input type="text" name="email" id="" class="form-control" placeholder="{{$user->email}}" style="margin-left: 10px">
                            </div>
                            <div class="form-group">
                                <label for="" style="margin-left: 10px">Phone*</label>
                                <input type="text" name="phone" id="" class="form-control" placeholder="{{$user->phone}}" style="margin-left: 10px">
                            </div>
                            <div class="form-group">
                                <label for="" style="margin-left: 10px">Address*</label>
                                <input type="text" name="address" id="" class="form-control" placeholder="{{$user->address}}" style="margin-left: 10px">
                            </div>
                            <div class="form-group">
                                <label for="" style="margin-left: 10px">Avatar</label>
                                <input type="file" name="avatar" id="" class="form-control" placeholder="Image" onchange="changeImage(event)" style="margin-left: 10px">
                            </div>
