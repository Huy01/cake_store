        ...
        <nav
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Add Type Product</h6>
                </nav>
                <div
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card my-4 col-4">
                        ...
                        @endif
                        <form action="{{route('add_type_product')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                    <input type="hidden" name="id_type" id="" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="" style="margin-left: 10px">Name*</label>
                                <input type="text" name="name" id="" class="form-control" placeholder="Product Type Name" style="margin-left: 10px">
                            </div>
                            <div class="form-group">
