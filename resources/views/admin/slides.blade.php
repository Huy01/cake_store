...
<nav
    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            ...
            <h6 class="font-weight-bolder mb-0">Slides</h6>
        </nav>
        <div
                ...
                >
                    ...
                    >
                        <h6 class="text-white text-capitalize ps-3">
                            Slides table
                            <a href="{{route('add-slide')}}" style="float:right; margin-right:20px">
                                Add Slide
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="{{route('delete_slide',$sl->id)}}" onsubmit="return ConfirmDelete( this )">
                                            @method('DELETE')
                                            @csrf
                                            <button type="submit">
