...
<aside
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white active bg-gradient-primary" href="{{route('productsType')}}">
                    <div
                        class="text-white text-center me-2 d-flex align-items-center justify-content-center"
                    >
                        <i class="material-icons opacity-10"
                    ...
                    <span class="nav-link-text ms-1">Type Products</span>
                </a>
            </li>
            <li class="nav-item">
                <a
...
<nav
    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            ...
            <h6 class="font-weight-bolder mb-0">Type Product</h6>
        </nav>
        <div
        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                >
                    ...
                    >
                        <h6 class="text-white text-capitalize ps-3">
                            Type Products table
                            <a href="{{route('add-type-product')}}" style="float:right; margin-right:20px">
                                Add Type Product
                ...
                <div class="card-body px-0 pb-2">
                    @if (session('success'))
                        <div class="alert alert-success" x-data="{show: true}" x-init="setTimeout(() => show = false, 2000)" x-show="show">
                            {{ session('success') }}
                        </div>
                    @endif
                    @if(Session::has('Done'))
                        <div class="alert alert-success" x-data="{show: true}" x-init="setTimeout(() => show = false, 2000)" x-show="show">{{Session::get('Done')}}</div>
                    @endif
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                @foreach($type as $type_pr)
                                <tr>
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            <div>
                                                <img
                                                    src="/source/image/product/{{$type_pr->image}}"
                                    ...
                                    <td class="align-middle">
                                        <a
                                            href="/admin/type_product/{{$type_pr->id}}/edit"
                                    ...
                                    <td>
                                        <form method="POST" action="{{route('delete-type-product',$type_pr->id)}}" onsubmit="return ConfirmDelete( this )">
                                            @method('DELETE')
                                            @csrf
                                            <button type="submit">
