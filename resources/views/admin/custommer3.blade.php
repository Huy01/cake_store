...
<body onload="time()">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><i class="fa fa-user-circle" aria-hidden="true"></i> QUẢN LÝ</a>
            </div>
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    <li class="active"><a href="#home" data-toggle="tooltip" data-placement="bottom"
                            title="NHÂN VIÊN">SẢN PHẨM</a></li>
                    <li><a href="" data-toggle="tooltip" data-placement="bottom" title="ĐIỂM DANH">HÓA ĐƠN</a></li>
                    <li><a href="" data-toggle="tooltip" data-placement="bottom" title="TIỀN LƯƠNG">TIN TỨC</a></li>
    ...
    <div class="container-fluid end">
        <div class="row text-center">
            ...
            <div class="col-lg-12">
                2022 CopyRight Phan mem quan ly | Design by <a href="#">HuyIT</a>
            </div>
        </div>
    </div>
