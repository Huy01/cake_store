                ...
                <div class="col-12">
                    ...
                    <div class="card my-4 col-4">
                        <form action="{{route('update_slide', $slide->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="" style="margin-left: 10px">Link</label>
                                <input type="text" name="link" id="" class="form-control" placeholder="{{$slide->link}}" style="margin-left: 10px">
                            </div>
                            <div class="form-group">
