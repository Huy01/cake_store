...
<aside
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item ">
                <a class="nav-link text-white active bg-gradient-primary" href="{{route('products')}}">
                    <div
                        class="text-white text-center me-2 d-flex align-items-center justify-content-center"
                    >
                ...
                >
                    ...
                    >
                        <h6 class="text-white text-capitalize ps-3">
                            Products table
                            <a href="{{route('add-product')}}" style="float:right; margin-right:20px">
                                Add Product
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="{{route('delete-product',$product->id)}}" onsubmit="return ConfirmDelete( this )">
                                            @method('DELETE')
                                            @csrf
                                            <button type="submit">
