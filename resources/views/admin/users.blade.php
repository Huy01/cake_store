                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a href="/admin/user/{{$user->id}}/edit" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip"data-original-title="Edit user">
                                                    <i class="fas fa-pencil"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <form method="POST" action="{{route('delete',$user->id)}}" onsubmit="return ConfirmDelete( this )">
                                                    @method('DELETE')
                                                    @csrf
                                                    <button type="submit">
