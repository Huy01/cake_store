                            ...
                            <div class="col-sm-4">
                                <div class="single-item">
                                    ...
                                    <div class="single-item-header">
                                        <a href="{{route('chi_tiet_san_pham', $sp->id)}}"><img src="source/image/product/{{$sp->image}}" alt="" style="height: 220px"></a>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="single-item">
                                    ...
                                    @endif
                                    <div class="single-item-header">
                                        <a href="product.html"><img src="source/image/product/{{$sp->image}}" alt="" style="height: 220px"></a>
                                    </div>
                                    <div class="single-item-body">
                                        <p class="single-item-title">{{$sp_khac->name}}</p>
                                        <p class="single-item-price">
                                        @if($sp_khac->promotion_price == 0) 
                                            <span class="flash-sale">{{number_format($sp_khac->unit_price)}}đ</span>
                                        
                                        @else
                                            <span class="flash-del">{{number_format($sp_khac->unit_price)}}đ</span>
                                            <span class="flash-sale">{{number_format($sp_khac->promotion_price)}}đ</span>
